<template>
    <div>
        <i class="fs-1 bi-laptop"></i><span class="fs-3 ms-1 d-none d-lg-inline">Сервис</span>
         ...
         methods: {
            ...
            async initMarkers(){
                ...
                if(this.full_access === 1){
                    await this.$store.dispatch('service/Mobile', user.session.client.key).then(
                        (data) => {
                    ...
                    await this.$store.dispatch('service/MobileBranch', {key:user.session.client.key, branch: branch}).then(
                     (data) => {
                        this.mobile = data.phones
                        this.mobile.forEach(phone => {
                            let location = ([phone.ltd,phone.lng])
            ...
            async getYesterday(){
                ...
                var user = this.$store.state.auth.user
                if(this.full_access === 1){
                    await this.$store.dispatch('service/yesterday', user.session.client.key).then(
                        (data) => {
                    ...
                    await this.$store.dispatch('service/yesterdayByBranch', user.session.client.key).then(
                    (data) => {
                        this.yesterday = data.allCount
                        this.counter --
                    },
            ...
            async getCountByStatus(){
                ...
                var user = this.$store.state.auth.user
                if(this.full_access === 1){
                    await this.$store.dispatch('service/countByStatus', user.session.client.key).then(
                        (data) => {
                   ...
                   await this.$store.dispatch('service/countByStatusBranch', user.session.client.key).then(
                        (data) => {
            ...
            async getCountByOrg(){
                ...
                var user = this.$store.state.auth.user
                if(this.full_access === 1){
                    await this.$store.dispatch('service/countByOrg', user.session.client.key).then(
                        (data) => {
                        ...
                        await this.$store.dispatch('service/countByOrgBranch', user.session.client.key).then(
                        (data) => {
                            this.countByOrg = data.items
                            //this.counter --
            ...
            async getCountByStaff(){
                ...
                this.counter ++
                 if(this.full_access === 1){
                    await this.$store.dispatch('service/countByStaff', user.session.client.key).then(
                        (data) => {
                    ...
                    let branch = this.$store.state.auth.user.session.branch.id
                    await this.$store.dispatch('service/countByStaffBranch', {key: user.session.client.key, branch: branch  }).then(
                    (data) => {
                        this.countByStaff = data.data
                        this.counter --
